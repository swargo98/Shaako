                    ...
                    <div className="row mb-3">
                        <div className="col-lg-4">
                            <div className="card mb-3">
                                <div className="card-body text-center shadow"><img className="rounded-circle mb-3 mt-4" src={man1} width="160" height="160"/>
                                    ...
                                    <div className="card shadow mb-3" style={{display: isReadOnly ? 'none' : ''}}>
                                        ...
                                        <div className="card-body">
                                            <form>
                                                <div className="row">
                                                    <div className="col">
                                                        <div className="mb-3"><label className="form-label" for="username"><strong>ইউজারনেম</strong></label><input
                                                        className="form-control" type="text" id="name" name="name" onChange={(e) => { handleChangename(e.target.value) }} value={name} /></div>
                                                    </div>
                                                    <div className="col">
                                                        <div className="mb-3"><label className="form-label" for="email"><strong>ইমেইল এড্রেস</strong></label><input
                                                ...
                                                <div className="row">
                                                    <div className="col">
                                                        <div className="mb-3"><label className="form-label" for="first_name"><strong>নতুন পাসওয়ার্ড</strong></label><input
                                                    ...
                                                    <div className="col">
                                                        <div className="mb-3"><label className="form-label" for="last_name"><strong>পুনরায় লিখুন</strong></label><input
                                                ...
                                                <div className="row">
                                                    <div className="col">
                                                        <div className="mb-3"><label className="form-label" for="first_name"><strong>পুরোনো পাসওয়ার্ড</strong></label><input
                                    ...
                                    <div className="card shadow mb-3" style={{display: isReadOnly ? '' : 'none'}}>
                                        ...
                                        <div className="card-body">
                                            <form>
                                                <div className="row">
                                                    <div className="col">
                                                        <div className="mb-3"><label className="form-label" for="username"><strong>ইউজারনেম</strong></label><input className="form-control" type="text" id="username-1" value={name} name="username" readOnly={true}/></div>
                                                    </div>
                                                    <div className="col">
                                                        <div className="mb-3"><label className="form-label" for="email"><strong>ইমেইল এড্রেস</strong></label><input className="form-control" type="email" id="email-1" value={email} name="email" readOnly={true}/></div>
                                                    </div>
                                                </div>                                                
