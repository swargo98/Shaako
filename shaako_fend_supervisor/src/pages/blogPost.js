                   ...
                   <div className="row">
                       <div className="col-md-10 col-lg-8 mx-auto position-relative">
                           <div className="post-heading">
                               <h1>Man must explore, and this is exploration at its greatest</h1><span className="meta">Posted by&nbsp;
                               <a href="#">Start Bootstrap</a>&nbsp;on August 24, 2018</span>
                           </div>
                       </div>
                   </div>
               </div>
                   ...
                   <div className="row">
                       <div className="col-md-10 col-lg-8 mx-auto">
                           ...
                           <p>As we got further and further away, it [the Earth] diminished in size. Finally it shrank
                               ...
                               crumble and fall apart. Seeing this has to change a man.</p><a href="#"><img
                           className="img-fluid" src={require("./assets/img/post-sample-image.jpg")}/></a><span
